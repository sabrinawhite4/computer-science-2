...
// ANSWER:
getNumbersSquared = (numbers) => {
  return +Array.from(numbers.toString(), (n) => n * n).join("");
};

console.log(getNumbersSquared(499));
...
// ANSWER: Used the resources available to me, to help me determine my correct answer.
...
const myFac = console.time("not memoized factorial"); // CREATE A NEW INSTANCE OF THE FACTORIAL CLASS
...
console.log(facInstance.calcFac(8));
console.log(facInstance.calcFac(8));
console.log(facInstance.calcFac(8));
console.log(facInstance.calcFac(8));
...
class dogTime {
  ...
  dustyPuppyThursday(num) {
    let newNumber = num * 44
    
    console.log( 'Happy Dusty Puppy Thursday!' + newNumber);

    this.cache[num] = newNumber;
    return newNumber;
  }
}


const pupInstance = new dogTime();
...
console.log(pupInstance.dustyPuppyThursday(4));
console.log(pupInstance.dustyPuppyThursday(4));
console.log(pupInstance.dustyPuppyThursday(4));
console.log(pupInstance.dustyPuppyThursday(4));
